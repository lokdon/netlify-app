...
{
     isFormControlValid(formGroup:FormGroup,controlName:string,submitted:boolean):boolean {
            if( formGroup.controls[controlName].invalid && 
            (formGroup.controls[controlName].dirty || 
            formGroup.controls[controlName].touched|| submitted))
            {
                return true;
            }
        ...
        {
        if(formGroup.controls[controlName].errors?.['required'])
        return true;
        ...
        {
            if(formGroup.controls[controlName].errors?.['email'])
            return true;

...
export class ContactsService implements IContactService {
  ...
  async createContactWithAddress(
    ...
    if (apiResponse.IsValid) {
      let savedAddressResponse = await this.addressService.createAddressAsync(
        contactModel.ContactAddress,
        addedContactModel.RecordId
      );
      if (savedAddressResponse.IsValid) {
        contactModel.ContactAddress.RecordId =
          savedAddressResponse.Success.RecordId;
        contactModel.ContactAddress.Address1 =
          savedAddressResponse.Success.Address1;
        contactModel.ContactAddress.Address2 =
          savedAddressResponse.Success.Address2;
        contactModel.ContactAddress.Country =
          savedAddressResponse.Success.Country;
        ...
        contactModel.ContactAddress.Pincode =
          savedAddressResponse.Success.Pincode;
      } else {
  ...
  async getContactByRecordIdAsync(
    recordId: string
  ): Promise<ApiResponseModel<ContactsModel>> {
    let apiResponse: ApiResponseModel<ContactsModel> = {
      IsValid: false,
  ...
  async getContactListByOwnerIdAsync(
    ownerId: string
  ): Promise<ApiResponseModel<ContactsModel[]>> {
    throw new Error('Method not implemented.');
  }
  async deleteContactByRecordIdAsync(
    recordId: string
  ): Promise<ApiResponseModel<boolean>> {
    throw new Error('Method not implemented.');
  }

  async getPaginatedContactListByUserIdAsync(
    userId: string,
